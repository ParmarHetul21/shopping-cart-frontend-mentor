...
import {increment_quantity, decrement_quantity, add_shoes} from "../redux/action"
...
function Section() {
  ...
  const addToCart = (e) => { 
      const d = new Date()
      const price = selector.counter * 125
      dispatch(add_shoes(d.getMilliseconds(), "Fall Limited Edition Sneaker", price))
  }
      ...
      <div className='section-container'>
          ...
          <div className='product-description'>
              ...
              <div className="cart-actions">
                <div>
                  <span className='cart-action-box' onClick={ () => dispatch(decrement_quantity())  }>-</span>
                  <span className='cart-action-box'>{selector.counter}</span>
                  <span className='cart-action-box' onClick={ () => dispatch(increment_quantity()) }>+</span>
                </div>
                <button className='shopping-cart' onClick={() => addToCart()}> 
